...
if TYPE_CHECKING:
    from ...germ.models import RegulatoryModel, Model, MetabolicModel, MetabolicModelWrapper


class CobraPyObject(Engine):
    ...
    """ def read(self,
        ...
        model.met_model = self.dto.cobra_model
    ...
    def read(self,
        ...
        model._met_model = self.dto.cobra_model
        model.set_simulator()
